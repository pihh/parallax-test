(self["webpackChunkux_tests"] = self["webpackChunkux_tests"] || []).push([["main"],{
...
const routes = [
    ...
    {
        path: 'other',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_other_other_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./other/other.module */ 3353)).then(m => m.OtherPageModule)
    },
];
